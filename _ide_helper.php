...
namespace Illuminate\Support\Facades {
    ...
    use Illuminate\Database\Schema\list;
    ...
    class Bus
    {
         ...
         *
         * @param  array|callable(PendingBatch):  bool  $callback
         * @return void
         *
         * @static
         */
         ...
         *
         * @param  callable(PendingBatch):  bool  $callback
         * @return \Illuminate\Support\Collection<int, PendingBatch>
         *
         * @static
         */
    ...
    class DB
    {
         ...
         *
         * @param  \Closure|Builder|Expression|\UnitEnum|string  $table
    ...
    class Event
    {
         ...
         *
         * @param  (callable(): (DatabaseTransactionsManager|null))  $resolver
         * @return \Illuminate\Events\Dispatcher
         *
         * @static
         */
    ...
    class Http
    {
         ...
         *
         * @param  string|null  $message
         * @return \Closure(\Illuminate\Http\Client\Request): PromiseInterface
         *
         * @static
         */
         ...
         *
         * @param  string  $url
         * @param  \Illuminate\Http\Client\Response|PromiseInterface|callable|int|string|array|ResponseSequence  $callback
         * @return \Illuminate\Http\Client\Factory
         *
         * @static
         */
    ...
    class Notification
    {
        ...
        public static function macro($name, $macro)
        {
            ChannelManager::macro($name, $macro);
        }
        ...
        public static function mixin($mixin, $replace = true)
        {
            ChannelManager::mixin($mixin, $replace);
        }
        ...
        public static function hasMacro($name)
        {
            return ChannelManager::hasMacro($name);
        }
    ...
    class Queue
    {
         ...
         * @param  (\Closure(mixed, CallQueuedListener, string|null, mixed): bool)|null  $callback
         * @return \Illuminate\Support\Collection<int, CallQueuedListener>
         *
         * @static
         */
    ...
    class Request
    {
         ...
         * @param  string|null  $key
         * @param  mixed  $default
         * @return ($key is null ? array<string, UploadedFile|UploadedFile[]> : UploadedFile|UploadedFile[]|null)
         *
         * @static
         */
        ...
        /**
         * @see FoundationServiceProvider::registerRequestSignatureValidation()
         *
        ...
        /**
         * @see ServiceProvider::registerRequestMacro()
         *
         * @static
         */
    ...
    class Route
    {
         ...
         *
         * @see ServiceProvider::registerRouterMacro()
         *
         * @static
         */
    ...
    class Schema
    {
        ...
        {
            // Method inherited from \Illuminate\Database\Schema\Builder
            return MySqlBuilder::defaultTimePrecision($precision);
        }
         ...
         *
         * @param  \Closure(Connection, string, \Closure|null):  Blueprint  $resolver
         * @return void
         *
         * @static
         */
        ...
        {
            // Method inherited from \Illuminate\Database\Schema\Builder
            MySqlBuilder::mixin($mixin, $replace);
        }
        ...
        {
            // Method inherited from \Illuminate\Database\Schema\Builder
            return MySqlBuilder::hasMacro($name);
        }
...
namespace Illuminate\Testing {
    ...
    {
        /**
         * @see TestResponseMacros::assertInertia()
         *
         * @param  \Closure|null  $callback
         *
         * @static
        ...
        /**
         * @see TestResponseMacros::inertiaPage()
         *
         * @static
         */
        ...
        /**
         * @see TestResponseMacros::inertiaProps()
         *
        ...
        /**
         * @see TestResponseMacros::assertInertiaFlash()
         *
         * @param  string  $key
        ...
        {
            return TestResponse::assertInertiaFlash($key, $expected);
        }

        /**
         * @see TestResponseMacros::assertInertiaFlashMissing()
         *
         * @param  string  $key
         *
         * @static
        ...
        {
            return TestResponse::assertInertiaFlashMissing($key);
        }
    }
}
...
namespace {
    ...
    class Eloquent extends Model
    {
         ...
         * @param  mixed  $id
         * @param  array|string  $columns
         * @return ($id is (Arrayable<array-key, mixed>|array<mixed>) ? Illuminate\Database\Eloquent\Collection<int, TModel> : TModel|null)
         *
         * @static
         */
         ...
         * @param  mixed  $id
         * @param  array|string  $columns
         * @return ($id is (Arrayable<array-key, mixed>|array<mixed>) ? Illuminate\Database\Eloquent\Collection<int, TModel> : TModel)
         *
         * @throws ModelNotFoundException<TModel>
         *
         * @static
         ...
         *
         * @param  Model|Illuminate\Database\Eloquent\Collection<int, Model>  $related
         ...
         *
         * @param  Expression|string  $column
         * @param  Collection<int, float>|Arrayable|array<int, float>|string  $vector
         * @param  string|null  $as
         * @return Builder<static>
         *
         * @static
         ...
         *
         * @param  Expression|string  $column
         * @param  Collection<int, float>|Arrayable|array<int, float>  $vector
         * @return Builder<static>
         *
         * @static
         */
