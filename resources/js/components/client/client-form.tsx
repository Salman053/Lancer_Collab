...
import { Building, Globe, Info, KeyRound, Loader2, Mail, MessageSquare, Phone, ShieldCheck, User } from 'lucide-react';
            ...
            {!hideHeader && (
                <CardHeader className="bg-muted/30 pb-8">
                    <div className="flex items-start justify-between">
                        ...
                        {!isEditing && (
                            <div className="bg-primary/10 text-primary hidden h-12 w-12 items-center justify-center rounded-full sm:flex">
            ...
            <form onSubmit={submit}>
                <CardContent className="space-y-8 p-6">
                    ...
                    {!isEditing && showPasswordHint && (
                        <Note variant="info" className="border-blue-200 bg-blue-50/50" onClose={() => setShowPasswordHint(false)}>
                            ...
                            <div className="bg-muted/20 space-y-4 rounded-lg p-4">
                                <div className="flex items-center justify-between">
                                    <div className="space-y-0.5">
                                        ...
                                        <p className="text-muted-foreground text-xs">Receive updates on project milestones</p>
                                    </div>
                                    <Checkbox
                                        id="notifications"
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="space-y-0.5">
                                        ...
                                        <p className="text-muted-foreground text-xs">Monthly product updates and news</p>
                                    </div>
                                    <Checkbox
                                        id="newsletter"
                            ...
                            {isEditing && (
                                <Note variant="info" className="bg-primary/5 border-primary/10">
                                    <div className="flex items-center gap-2 text-xs">
                                        ...
                                        <span>
                                            Portal security can be managed in the <strong className="text-primary">Client Access</strong> tab.
                                        </span>
                                    </div>
                                </Note>
                            )}
                ...
                <CardFooter className="bg-muted/30 flex items-center justify-between p-6">
                    <Button
                        type="button"
                        variant="ghost"
                        onClick={() => reset()}
